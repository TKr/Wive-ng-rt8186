...
enum
{
	...
	NET_IPV4_TCP_RESTRICT_RST=30,
	NET_IPV4_UDP_RESTRICT_PU=31,
	NET_IPV4_IGMP_RESTRICT=32,
#endif
	...
	NET_TCP_TW_REUSE=91,
	NET_TCP_WESTWOOD=92,
	NET_TCP_DELACK_STRATEGY=93,
	NET_IPV4_ICMP_RESTRICT=94,
	NET_IPV4_TCP_RESTRICT=95,
