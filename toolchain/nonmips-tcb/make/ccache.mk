...
#
#############################################################
CCACHE_SITE:=http://wive-ng.sourceforge.net/downloads
CCACHE_SOURCE:=ccache-2.4.tar.gz
CCACHE_DIR1:=$(TOOL_BUILD_DIR)/ccache-2.4
CCACHE_DIR2:=$(BUILD_DIR)/ccache-2.4
CCACHE_CAT:=zcat
