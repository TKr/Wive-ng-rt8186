 ...
 * for more details.
 *
 * RCSID $Id: pfkey_v2_ext_bits.c,v 1.1 2005/02/22 02:00:11 rupert Exp $
 */
...
char pfkey_v2_ext_bits_c_version[] = "$Id: pfkey_v2_ext_bits.c,v 1.1 2005/02/22 02:00:11 rupert Exp $";
