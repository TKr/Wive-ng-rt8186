...

	{
		...
		*/
		...
		if (ExtP1P4GigaPhyMode) 
		{
			...
			para.externalPHYId[1] = CONFIG_RTL8214_PHYID_P1;
			para.externalPHYId[2] = CONFIG_RTL8214_PHYID_P1+1;
			para.externalPHYId[3] = CONFIG_RTL8214_PHYID_P1+2;
			para.externalPHYId[4] = CONFIG_RTL8214_PHYID_P1+3;
		}
		#endif
