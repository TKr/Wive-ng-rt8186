...
* $Id: rtl865xC_layer2asic.c,v 1.10 2009/02/24 05:18:25 joeylin Exp $
*/
...
int8 rtl8651_layer2Asic_Id[] = "$Id: rtl865xC_layer2asic.c,v 1.10 2009/02/24 05:18:25 joeylin Exp $";
			...
			*/
				...
				( currentSwBandwidthCtrlSetting != currentAsicBandwidthCtrlSetting ))
			{
				retval = (cfgTypeIdx == 0)?
					...
					/* 0: no limit for IngressBandwidth, not 0x3fff */
					(rtl8651_setAsicPortIngressBandwidth(port, currentSwBandwidthCtrlSetting)) :
#else
