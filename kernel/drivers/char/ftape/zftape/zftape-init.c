...
char zft_src[] __initdata = "$Source: /home/cvs/RtlLinux/linux-2.4.18-rtl/drivers/char/ftape/zftape/zftape-init.c,v $";
char zft_rev[] __initdata = "$Revision: 1.1.1.1 $";
char zft_dat[] __initdata = "$Date: 2005/03/09 04:53:46 $";
