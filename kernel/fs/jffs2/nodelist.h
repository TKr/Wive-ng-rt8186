 ...
 *
 * $Id: nodelist.h,v 1.1.1.1 2005/03/09 04:54:21 rex Exp $
 *
 */
...
// Changed by dgreen
// It's not very good idea - but at now we have only 5 sectors
// 
#if 0
...
#define JFFS2_RESERVED_BLOCKS_WRITE (JFFS2_RESERVED_BLOCKS_BASE + 0)
...
#define JFFS2_RESERVED_BLOCKS_GCMERGE (JFFS2_RESERVED_BLOCKS_BASE+1)
