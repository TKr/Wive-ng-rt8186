...
#define TX_TIMEOUT (50*HZ/100)		/* Time in jiffies before concluding the transmitter is hung. (500ms) */
...
struct net_device
{
	...
	/* List of functions to handle Wireless Extensions (instead of ioctl).
        ...
        // struct iw_handler_def * wireless_handlers; /* conflict in closed sources drivers */
