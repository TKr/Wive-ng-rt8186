...
struct sk_buff *alloc_skb(unsigned int size,int gfp_mask)
{
	...
	//sc_yang : Add addition 8 bytes for rtl8186 tkip or more for speedup
	size = SKB_DATA_ALIGN(size + MAX_SPEEDUP_BUFF);
...
#if 0
/*
 *     Tune the memory allocator for a new MTU size. from rtl SDK
 */
