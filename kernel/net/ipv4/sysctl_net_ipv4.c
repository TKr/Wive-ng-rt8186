 ...
 *
 * $Id: sysctl_net_ipv4.c,v 1.2 2006/11/22 11:26:45 bradhuang Exp $
 *
...
#include <net/tcp.h>
 ...
 /* From tcp_input.c */
extern int sysctl_tcp_delack_strategy;
...
ctl_table ipv4_table[] = {
	...
	{NET_TCP_DELACK_STRATEGY, "tcp_delack_strategy",
	&sysctl_tcp_delack_strategy, sizeof(int), 0644, NULL, &proc_dointvec},
...
#ifdef CONFIG_TCP_WESTWOOD
	{NET_TCP_WESTWOOD, "tcp_westwood", &sysctl_westwood, sizeof(int), 0644, NULL, &proc_dointvec},
#endif
	{0}
};
