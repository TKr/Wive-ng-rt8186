 ...
 *
 *	$Id: wsc.h,v 1.5 2007/09/28 06:46:00 xl Exp $
 */
/*================================================================*/
...
#define SESSION_OVERLAP_TIME		30 // insec
...
#define WEB_PID_FILENAME			("/var/run/webs.pid")
...
#ifdef CONFIG_RTL8186_KB
	#define LED_WSC_START			4
	#define LED_WSC_END				3
	#define LED_PBC_OVERLAPPED		LED_WSC_END
	...
	#define LED_WSC_OK				1
//added by xl_yue
#elif defined(REVERSE_WPS_LED)
	#define LED_WSC_START			2
	#define LED_WSC_END				1
	#define LED_PBC_OVERLAPPED		0	
#else
	#define LED_WSC_START			2
	#define LED_WSC_END				0
	#define LED_PBC_OVERLAPPED		1	
#endif
