 ...
 */
#define AUTOCONF_TIMESTAMP "2009-06-17 07:41:04 OMSST"
...
#define USE_FEATURE_ASSUME_UNICODE(...) __VA_ARGS__
#define SKIP_FEATURE_ASSUME_UNICODE(...)
...
#define USE_FTPD(...)
#define SKIP_FTPD(...) __VA_ARGS__
#undef CONFIG_FEATURE_FTP_WRITE
#define ENABLE_FEATURE_FTP_WRITE 0
#define USE_FEATURE_FTP_WRITE(...)
#define SKIP_FEATURE_FTP_WRITE(...) __VA_ARGS__
...
#define USE_FEATURE_SH_NOFORK(...) __VA_ARGS__
#define SKIP_FEATURE_SH_NOFORK(...)
